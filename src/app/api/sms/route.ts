...
/**
 * GET /api/sms?id={activationId}
 *
 * Mengambil SEMUA SMS yang masuk ke satu nomor aktivasi.
 * Berguna ketika app mengirim OTP berkali-kali ke nomor yang sama.
 *
 * Response sukses:
 *   Array<{ code: string; service: string; text: string }>
 *
 * Response error:
 *   { error: string }
 */

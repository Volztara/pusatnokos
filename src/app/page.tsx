  ...
  return (
    <div suppressHydrationWarning className="min-h-screen bg-[#f4f5f9] dark:bg-[#060810] flex flex-col md:flex-row font-sans relative transition-colors duration-300 overflow-x-hidden" style={{ minHeight: "100svh" }}>
      ...
      <div className="hidden md:flex flex-col w-72 border-r border-slate-200/80 dark:border-white/[0.06] fixed h-full z-10 transition-colors duration-300 bg-white dark:bg-[#0b0e1a] shadow-sm dark:shadow-[4px_0_24px_rgba(0,0,0,0.3)]">
        ...
        {/* Bottom sidebar: Hubungi Kami */}
        <div className="px-5 pt-3 border-t border-slate-100 dark:border-white/[0.07] relative">
          <button onClick={() => setShowContactMenu(v => !v)} className="w-full flex items-center justify-between gap-3 px-4 py-3 bg-slate-50 dark:bg-[#0f1320] hover:bg-slate-100 dark:hover:bg-white/[0.1] text-slate-600 dark:text-slate-400 font-bold rounded-2xl transition-all text-sm">
            <div className="flex items-center gap-3">
            ...
            <div className="bg-white dark:bg-[#0a0d16] w-[280px] h-full flex flex-col shadow-2xl animate-in slide-in-from-left-full duration-300" onClick={e => e.stopPropagation()}>
              ...
              <div className="p-5 border-t border-slate-100 dark:border-white/[0.07] space-y-2">
                ...
                <div className="rounded-2xl overflow-hidden">
                  <button onClick={() => setShowContactMenu(v => !v)} className="w-full flex items-center justify-between gap-3 px-4 py-3 bg-slate-50 dark:bg-[#0f1320] text-slate-600 dark:text-slate-400 font-bold transition-all text-sm">
                    <span className="flex items-center gap-3"><MessageCircle className="w-4 h-4 text-green-500 shrink-0" />Hubungi Kami</span>
                    <ChevronDown className={"w-4 h-4 transition-transform shrink-0 " + (showContactMenu ? 'rotate-180' : '')} />
                  </button>
                  {showContactMenu && (
                    <div className="bg-slate-50 dark:bg-[#0f1320] border-t border-slate-100 dark:border-white/[0.09]">
                      {[
                        ...
                        <a key={item.label} href={item.href} target="_blank" rel="noopener noreferrer"
                          ...
                          className={`flex items-center justify-between px-4 py-3 bg-white dark:bg-[#0a0d16] hover:bg-slate-50 dark:hover:bg-white/[0.05] text-xs font-bold transition-colors border-b border-slate-100 dark:border-white/[0.05] last:border-0 ${item.color}`}>
                          {item.label}
